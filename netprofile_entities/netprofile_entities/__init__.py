...
class Module(ModuleBase):
    ...
    def get_sql_views(cls):
        from netprofile_entities import models
        return (models.EntitiesBaseView,)
    ...
    def get_sql_data(cls, modobj, vpair, sess):
        ...
        sess.add(LogType(id=2,
                         name='Entities'))
        sess.flush()

        privs = (Privilege(code='BASE_ENTITIES',
                           name=_('Menu: Entities')),
                 Privilege(code='ENTITIES_LIST',
                           name=_('Entities: List')),
                 Privilege(code='ENTITIES_CREATE',
                           name=_('Entities: Create')),
                 Privilege(code='ENTITIES_EDIT',
                           name=_('Entities: Edit')),
                 Privilege(code='ENTITIES_DELETE',
                           name=_('Entities: Delete')),
                 Privilege(code='FILES_ATTACH_2ENTITIES',
                           name=_('Files: Attach to entities')),
                 Privilege(code='ENTITIES_STATES_CREATE',
                           name=_('Entities: Create states')),
                 Privilege(code='ENTITIES_STATES_EDIT',
                           name=_('Entities: Edit states')),
                 Privilege(code='ENTITIES_STATES_DELETE',
                           name=_('Entities: Delete states')),
                 Privilege(code='ENTITIES_FLAGTYPES_CREATE',
                           name=_('Entities: Create flag types')),
                 Privilege(code='ENTITIES_FLAGTYPES_EDIT',
                           name=_('Entities: Edit flag types')),
                 Privilege(code='ENTITIES_FLAGTYPES_DELETE',
                           name=_('Entities: Delete flag types')),
                 Privilege(code='ENTITIES_COMMENT',
                           name=_('Entities: Add comments')),
                 Privilege(code='ENTITIES_COMMENTS_EDIT',
                           name=_('Entities: Edit comments')),
                 Privilege(code='ENTITIES_COMMENTS_DELETE',
                           name=_('Entities: Delete comments')),
                 Privilege(code='ENTITIES_COMMENTS_MARK',
        ...
        types = (
            ...
            models.EntityType(
                ...
                description=_('Definition of a legal entity '
            ...
            models.EntityType(
                ...
                long_name=('Structure'),
                plural=_('Structures'),
                description=_('Definition of a building '
                              'or a comparable structure.')),
            models.EntityType(
                id=4,
                name=_('Misc.'),
                ...
                description=_('Definition of an object without '
        ...
        sess.add(models.EntityState(
            name='Default',
            description='Default entity state. You can safely rename and/or '
                        'delete it if you wish.'))

    def get_local_js(self, request, lang):
        return ('netprofile_entities:static/webshell/locale/webshell-lang-'
                + lang + '.js',)

    def get_autoload_js(self, request):
        return ('NetProfile.entities.grid.HistoryGrid',)

    def get_css(self, request):
        return ('netprofile_entities:static/css/main.css',)
