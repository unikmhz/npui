...
# -*- coding: utf-8 -*-
#
# NetProfile: Setup script for netprofile_entities package
...
setup(
    name='netprofile_entities',
    version=versioneer.get_version(),
    cmdclass=commands,
    description='NetProfile Administrative UI - Entities Module',
    ...
    zip_safe=False,
    test_suite='netprofile_entities',
    install_requires=requires,
    entry_points={
        'netprofile.modules': [
            'entities = netprofile_entities:Module'
        ]
    },
    message_extractors={'.': [
        ('**.py', 'python', None),
