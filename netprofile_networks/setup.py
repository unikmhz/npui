...
# -*- coding: utf-8 -*-
#
# NetProfile: Setup script for netprofile_networks package
...
requires = [
    ...
    'netprofile_devices >= 0'
]

setup(
    name='netprofile_networks',
    version=versioneer.get_version(),
    cmdclass=commands,
    description='NetProfile Administrative UI - Networks Module',
    ...
    zip_safe=False,
    test_suite='netprofile_networks',
    install_requires=requires,
    entry_points={
        'netprofile.modules': [
            'networks = netprofile_networks:Module'
        ]
    },
    message_extractors={'.': [
        ('**.py', 'python', None),
