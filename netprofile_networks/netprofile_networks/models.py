...
#convert decimal ip-addresses to dotted
class Network(Base):
    """
    ...
    __table_args__ = (
        Comment('Networks'),
        {
            ...
            'info'          : {
                ...
                'form_view' : ('netid', 'name', 'netdomain', 'netgroup', 'netdevice', 'enabled', 'public', 'ipaddr', 'ip6addr', 'cidr', 'cidr6', 'vlanid', 'rtid', 'gueststart', 'guestend', 'gueststart6', 'guestend6', 'descr'),
                'easy_search' : ('name',),
