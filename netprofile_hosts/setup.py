...
# -*- coding: utf-8 -*-
#
# NetProfile: Setup script for netprofile_hosts package
...
requires = [
    ...
    'netprofile_domains >= 0'
]

setup(
    name='netprofile_hosts',
    version=versioneer.get_version(),
    cmdclass=commands,
    description='NetProfile Administrative UI - Hosts Module',
    ...
    zip_safe=False,
    test_suite='netprofile_hosts',
    install_requires=requires,
    entry_points={
        'netprofile.modules': [
            'hosts = netprofile_hosts:Module'
        ]
    },
    message_extractors={'.': [
        ('**.py', 'python', None),
