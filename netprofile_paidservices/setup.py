...
# -*- coding: utf-8 -*-
#
# NetProfile: Setup script for netprofile_paidservices package
...
setup(
    name='netprofile_paidservices',
    version=versioneer.get_version(),
    cmdclass=commands,
    description='NetProfile Administrative UI - Paid Services Module',
    ...
    zip_safe=False,
    test_suite='netprofile_paidservices',
    install_requires=requires,
    entry_points={
        'netprofile.modules': [
            'paidservices = netprofile_paidservices:Module'
        ]
    },
    message_extractors={'.': [
        ('**.py', 'python', None),
