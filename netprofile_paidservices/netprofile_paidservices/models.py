    ...
    __table_args__ = (
        ...
        Index('paid_types_u_name', 'name', unique=True),
        {
            ...
            'info':          {
                ...
                'grid_view':     ('paidid', 'name', 'isum', 'qsum',
                                  'qp_amount', 'qp_unit', 'qp_type',
                                  'sp_amount'),
                'grid_hidden':   ('paidid', 'sp_amount'),
                'form_view':     ('name', 'isum', 'qsum',
                                  'qp_amount', 'qp_unit', 'qp_type',
                                  'qp_order', 'sp_amount',
                                  'cb_before', 'cb_success',
                                  'cb_failure', 'cb_ratemod',
                                  'descr'),
                'easy_search':   ('name', 'descr'),
                'extra_data':    ('formatted_initial_sum',
                                  'formatted_quota_sum'),
...
class PaidService(Base):
    ...
    entity_id = Column(
        ...
        UInt32(),
        Comment('Entity ID'),
        ForeignKey('entities_def.entityid', name='paid_def_fk_entityid',
    ...
    access_entity_id = Column(
        ...
        ForeignKey('entities_access.entityid', name='paid_def_fk_aeid',
                   onupdate='CASCADE', ondelete='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    host_id = Column(
        ...
        UInt32(),
        Comment('Host ID'),
        ForeignKey('hosts_def.hostid', name='paid_def_fk_hostid',
                   onupdate='CASCADE', ondelete='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    stash_id = Column(
        'stashid',
        UInt32(),
        ForeignKey('stashes_def.stashid', name='paid_def_fk_stashid',
                   onupdate='CASCADE', ondelete='CASCADE'),
    ...
    paid_id = Column(
        'paidid',
        UInt32(),
        ForeignKey('paid_types.paidid', name='paid_def_fk_paidid',
                   onupdate='CASCADE'),
        Comment('Type ID'),
        nullable=False,
        info={
...
PSCallbackProcedure = SQLFunction(
    'ps_callback',
    args=(InArgument('cbname', Unicode(255)),
