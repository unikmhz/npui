...
class Module(ModuleBase):
    ...
    def get_models(cls):
        ...
        return (models.PaidService,
                models.PaidServiceType)

    @classmethod
    def get_sql_functions(cls):
        from netprofile_paidservices import models
        return (models.PSCallbackProcedure,
    ...
    def get_css(self, request):
        return ('netprofile_paidservices:static/css/main.css',)
