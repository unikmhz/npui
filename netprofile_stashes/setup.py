...
# -*- coding: utf-8 -*-
#
# NetProfile: Setup script for netprofile_stashes package
...
setup(
    name='netprofile_stashes',
    version=versioneer.get_version(),
    cmdclass=commands,
    description='NetProfile Administrative UI - Stashes Module',
    ...
    zip_safe=False,
    test_suite='netprofile_stashes',
    install_requires=requires,
    entry_points={
        'netprofile.modules': [
            'stashes = netprofile_stashes:Module'
        ]
    },
    message_extractors={'.': [
        ('**.py', 'python', None),
