...
class Domain(Base):
	...
	#hostdomains = relationship('Host', backref=backref('hostdomains', innerjoin=True))
	#hostaliasdomains = relationship('HostAlias', backref=backref('hostaliasdomains', innerjoin=True))
	#hostrealdomains = relationship('HostReal', backref=backref('hostrealdomains', innerjoin=True))
