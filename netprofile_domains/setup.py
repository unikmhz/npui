...
# -*- coding: utf-8 -*-
#
# NetProfile: Setup script for netprofile_domains package
...
setup(
    name='netprofile_domains',
    version=versioneer.get_version(),
    cmdclass=commands,
    description='NetProfile Administrative UI - Domains Module',
    ...
    zip_safe=False,
    test_suite='netprofile_domains',
    install_requires=requires,
    entry_points={
        'netprofile.modules': [
            'domains = netprofile_domains:Module'
        ]
    },
    message_extractors={'.': [
        ('**.py', 'python', None),
