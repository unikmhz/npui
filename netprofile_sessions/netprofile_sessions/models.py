...
class AccessSession(Base):
    ...
    __table_args__ = (
        ...
        Trigger('after', 'delete', 't_sessions_def_ad'),
        {
            ...
            'info':          {
                ...
                'menu_main':     True,
                'default_sort':  ({'property': 'updatets',
                                   'direction': 'DESC'},),
                'grid_view':     ('sessid',
                                  'nas', 'name',
                                  'entity', 'csid', 'called',
                ...
                'form_view':     ('stationid', 'nas', 'called', 'name',
                                  'entity', 'csid',
    ...
    entity_id = Column(
        ...
        ForeignKey('entities_access.entityid', name='sessions_def_fk_entityid',
    ...
    ipv4_address_id = Column(
        ...
        ForeignKey('ipaddr_def.ipaddrid', name='sessions_def_fk_ipaddrid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    ipv6_address_id = Column(
        ...
        ForeignKey('ip6addr_def.ip6addrid', name='sessions_def_fk_ip6addrid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    destination_id = Column(
        ...
        ForeignKey('dest_def.destid', name='sessions_def_fk_destid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    nas_id = Column(
        ...
        ForeignKey('nas_def.nasid', name='sessions_def_fk_nasid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
...
class AccessSessionHistory(Base):
    ...
    entity_id = Column(
        ...
        ForeignKey('entities_access.entityid',
                   name='sessions_history_fk_entityid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    ipv4_address_id = Column(
        ...
        UInt32(),
        Comment('IPv4 address ID'),
        ForeignKey('ipaddr_def.ipaddrid', name='sessions_history_fk_ipaddrid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    ipv6_address_id = Column(
        ...
        ForeignKey('ip6addr_def.ip6addrid',
                   name='sessions_history_fk_ip6addrid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    destination_id = Column(
        ...
        UInt32(),
        Comment('Accounting destination ID'),
        ForeignKey('dest_def.destid', name='sessions_history_fk_destid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    nas_id = Column(
        ...
        UInt32(),
        Comment('Network access server ID'),
        ForeignKey('nas_def.nasid', name='sessions_history_fk_nasid',
                   ondelete='SET NULL', onupdate='CASCADE'),
        nullable=True,
        default=None,
        server_default=text('NULL'),
    ...
    entity = relationship(
        'AccessEntity',
        backref=backref('closed_sessions',
                        passive_deletes=True))
    ipv4_address = relationship(
        'IPv4Address',
        backref=backref('closed_sessions',
...
AcctAddSessionProcedure = SQLFunction(
    'acct_add_session',
    args=(InArgument('sid', Unicode(255)),
...
AcctAllocIPProcedure = SQLFunction(
    'acct_alloc_ip',
    args=(InArgument('nid', Unicode(255)),
