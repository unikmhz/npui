...
class Module(ModuleBase):
    def __init__(self, mmgr):
        ...
        mmgr.cfg.register_block('stashes.cl.block.entity_menu',
                                TemplateObject('netprofile_sessions:templates'
                                               '/client_block_sessions.mak'))
    ...
    def get_models(cls):
        ...
        return (models.AccessSession,
                models.AccessSessionHistory)

    @classmethod
    def get_sql_functions(cls):
        from netprofile_sessions import models
        return (models.AcctAddSessionProcedure,
    ...
    def get_sql_events(cls):
        from netprofile_sessions import models
        return (models.IPAddrClearStaleEvent,
    ...
    def get_sql_data(cls, modobj, vpair, sess):
        ...
        privs = (Privilege(code='BASE_SESSIONS',
                           name=_('Menu: Sessions')),
                 Privilege(code='SESSIONS_LIST',
    ...
    def get_css(self, request):
        return ('netprofile_sessions:static/css/main.css',)
            ...
            return (
                SettingSection(
                    ...
                    Setting(
                        ...
                        help_text=_('Interval (in seconds) between session '
                                    'accounting reports.'),
                        type='int',
                        default=60,
                        write_cap='ADMIN_DB',
                    ...
                    Setting(
                        ...
                        help_text=_('Maximum session inactivity time '
                                    '(in seconds) before it is considered '
                                    'stale and closed down.'),
                        type='int',
                        default=130,
                        write_cap='ADMIN_DB',
