## -*- coding: utf-8 -*-
##
## NetProfile: HTML template for login page
...
% endfor
	...
	<input type="text" class="form-control" placeholder="${_('E-mail') if maillogin else _('User Name')}" required="required" aria-required="true" autofocus="autofocus" id="user" name="user" title="${_('Enter your e-mail address') if maillogin else _('Enter your user name here')}" value="" maxlength="254" tabindex="1" autocomplete="off" />
	<input type="password" class="form-control" placeholder="${_('Password')}" required="required" aria-required="true" id="pass" name="pass" title="${_('Enter your password here')}" value="" maxlength="254" tabindex="2" autocomplete="off" />
