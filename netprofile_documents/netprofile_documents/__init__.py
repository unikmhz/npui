...
class Module(ModuleBase):
    ...
    def add_routes(self, config):
        config.add_route('documents.generate.single',
                         '/gen/single',
                         vhost='MAIN')
        config.add_route('documents.generate.bundle',
                         '/gen/bundle',
                         vhost='MAIN')
    ...
    def get_autoload_js(self, request):
        return ('NetProfile.documents.button.DocumentButton',)

    def get_css(self, request):
        return ('netprofile_documents:static/css/main.css',)
