...
class Module(ModuleBase):
    ...
    def get_sql_functions(cls):
        from netprofile_rates import models
        return (models.AcctRateDestProcedure,
    ...
    def get_sql_data(cls, modobj, vpair, sess):
        ...
        sess.add(LogType(id=13,
                         name='Rates'))

        privs = (Privilege(code='BASE_RATES',
                           name=_('Menu: Rates')),
                 Privilege(code='RATES_LIST',
                           name=_('Rates: List')),
                 Privilege(code='RATES_CREATE',
                           name=_('Rates: Create')),
                 Privilege(code='RATES_EDIT',
                           name=_('Rates: Edit')),
                 Privilege(code='RATES_DELETE',
                           name=_('Rates: Delete')),
                 Privilege(code='RATES_CLASSES_CREATE',
                           name=_('Rates: Create classes')),
                 Privilege(code='RATES_CLASSES_EDIT',
                           name=_('Rates: Edit classes')),
                 Privilege(code='RATES_CLASSES_DELETE',
                           name=_('Rates: Delete classes')),
                 Privilege(code='RATES_DS_CREATE',
                           name=_('Rates: Create destinations')),
                 Privilege(code='RATES_DS_EDIT',
                           name=_('Rates: Edit destinations')),
                 Privilege(code='RATES_DS_DELETE',
                           name=_('Rates: Delete destinations')),
                 Privilege(code='RATES_FS_CREATE',
                           name=_('Rates: Create filters')),
                 Privilege(code='RATES_FS_EDIT',
                           name=_('Rates: Edit filters')),
                 Privilege(code='RATES_FS_DELETE',
        ...
        sess.add(RateClass(
            name='Default Class',
            description='This is a class added during module installation. '
                        'You can safely remove it, provided you haven\'t '
                        'specified any rates in this class yet.'))

        sess.add(DestinationSet(name='Default Set'))
        sess.add(FilterSet(name='Default Set'))

    def get_css(self, request):
        return ('netprofile_rates:static/css/main.css',)
