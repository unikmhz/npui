...
Ext.define('Ext.ux.grid.filter.DateFilter', {
	...
	getSerialArgs: function()
	{
		...
		{
			if(this.fields[key].checked)
				//ret[this.compareMap[key]] = this.getFieldValue(key);
				//ret[this.compareMap[key]] = Ext.Date.format(this.getFieldValue(key), this.dateFormat);
				ret[this.compareMap[key]] = Ext.Date.format(this.getFieldValue(key), 'c');
		}
		return ret;
	},
