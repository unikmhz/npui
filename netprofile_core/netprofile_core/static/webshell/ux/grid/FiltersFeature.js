...
Ext.define('Ext.ux.grid.FiltersFeature', {
     ...
     * Defaults to <tt>'__filter'</tt>.
     */
    paramPrefix : '__filter',
    /**
    ...
    attachEvents: function() {
		...
		// Fix state restore bug in extjs 4.1.1
		me.createFilters();
