...
from netprofile.dav.interfaces import IDAVManager
from netprofile.dav.nodes import (
    DAVRoot,
    DAVTraverser
)
...
class Module(ModuleBase):
    def __init__(self, mmgr):
        ...
        cfg.add_route('core.dav', '/dav*traverse',
                      factory='netprofile.dav.DAVRoot',
                      vhost='MAIN')
    ...
    def add_routes(self, config):
        ...
        config.add_route('core.file.download',
                         '/file/dl/{fileid:\d+}*filename',
                         vhost='MAIN')
        config.add_route('core.file.upload', '/file/ul', vhost='MAIN')
        config.add_route('core.file.mount',
                         '/file/mount/{ffid:\d+|root}*filename',
                         vhost='MAIN')
        config.add_route('core.export',
                         '/file/export/{module:[\w_.-]+}/{model:[\w_.-]+}',
                         vhost='MAIN')

    @classmethod
    def get_models(cls):
        from netprofile_core import models
        return (models.NPModule,
                models.NPVariable,
                models.TaskSchedule,
                models.Task,
                models.TaskLog,
                ...
                models.DAVHistory,
                models.Calendar,
                models.CalendarImport,
                models.Event,
                models.AddressBook,
                models.AddressBookCard,
                models.CommunicationType,
                models.UserCommunicationChannel,
                models.UserPhone,
                models.UserEmail)
    ...
    def get_sql_functions(cls):
        from netprofile_core import models
        return (models.HWAddrHexIEEEFunction,
                models.HWAddrHexLinuxFunction,
                models.HWAddrHexWindowsFunction,
                models.HWAddrUnhexFunction)
    ...
    def get_sql_data(cls, modobj, vpair, sess):
        ...
        log = (LogAction(id=1, name='Created'),
        ...
        privs = (Privilege(code='BASE_ADMIN',
                           name=_('Menu: Administrative tasks')),
                 Privilege(code='BASE_USERS',
                           name=_('Menu: Users')),
                 Privilege(code='BASE_GROUPS',
                           name=_('Menu: Groups')),
                 Privilege(code='BASE_FILES',
                           name=_('Menu: Files')),
                 Privilege(code='BASE_TASKS',
                           name=_('Menu: Periodic Tasks')),
                 Privilege(code='ADMIN_SETTINGS',
                           name=_('Administrative: Settings')),
                 Privilege(code='ADMIN_SECURITY',
                           name=_('Administrative: Security')),
                 Privilege(code='ADMIN_MODULES',
                           name=_('Administrative: Modules')),
                 Privilege(code='ADMIN_DB',
                           name=_('Administrative: Database ops')),
                 Privilege(code='ADMIN_VFS',
                           name=_('Administrative: File system')),
                 Privilege(code='ADMIN_DEV',
                           name=_('Administrative: Development')),
                 Privilege(code='ADMIN_AUDIT',
                           name=_('Administrative: Audit log')),
                 Privilege(code='USERS_LIST',
                           name=_('Users: List')),
                 Privilege(code='USERS_CREATE',
                           name=_('Users: Create'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='USERS_EDIT',
                           name=_('Users: Edit'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='USERS_DELETE',
                           name=_('Users: Delete'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='USERS_GETCAP',
                           name=_('Users: Display capabilities')),
                 Privilege(code='USERS_SETCAP',
                           name=_('Users: Modify capabilities'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='USERS_GETACL',
                           name=_('Users: Display ACLs')),
                 Privilege(code='USERS_SETACL',
                           name=_('Users: Set ACLs'),
                           has_acls=True,
                           resource_class='NPUser'),
                 Privilege(code='GROUPS_LIST',
                           name=_('Groups: List')),
                 Privilege(code='GROUPS_CREATE',
                           name=_('Groups: Create'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='GROUPS_EDIT',
                           name=_('Groups: Edit'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='GROUPS_DELETE',
                           name=_('Groups: Delete'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='GROUPS_GETCAP',
                           name=_('Groups: Display capabilities')),
                 Privilege(code='GROUPS_SETCAP',
                           name=_('Groups: Modify capabilities'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='GROUPS_GETACL',
                           name=_('Groups: Display ACLs')),
                 Privilege(code='GROUPS_SETACL',
                           name=_('Groups: Set ACLs'),
                           has_acls=True,
                           resource_class='NPGroup'),
                 Privilege(code='FILES_LIST',
                           name=_('Files: List')),
                 Privilege(code='FILES_SHOWALL',
                           name=_('Files: Full access')),
                 Privilege(code='FILES_UPLOAD',
                           name=_('Files: Upload')),
                 Privilege(code='FILES_DELETE',
                           name=_('Files: Delete')),
                 Privilege(code='FILES_EDIT',
                           name=_('Files: Edit')),
                 Privilege(code='TASKS_LIST',
                           name=_('Tasks: List')),
                 Privilege(code='TASKS_CREATE',
                           name=_('Tasks: Create')),
                 Privilege(code='TASKS_EDIT',
                           name=_('Tasks: Edit')),
                 Privilege(code='TASKS_DELETE',
                           name=_('Tasks: Delete')),
                 Privilege(code='PRIVILEGES_LIST',
                           name=_('Privileges: List')),
                 Privilege(code='PRIVILEGES_CREATE',
                           name=_('Privileges: Create')),
                 Privilege(code='PRIVILEGES_EDIT',
                           name=_('Privileges: Edit')),
                 Privilege(code='PRIVILEGES_DELETE',
                           name=_('Privileges: Delete')),
                 Privilege(code='SECPOL_LIST',
                           name=_('Security Policies: List')),
                 Privilege(code='SECPOL_CREATE',
                           name=_('Security Policies: Create')),
                 Privilege(code='SECPOL_EDIT',
                           name=_('Security Policies: Edit')),
                 Privilege(code='SECPOL_DELETE',
        ...
        sess.add(admin)
        logger.critical('Generated initial administrative credentials: '
                        'admin / %s', pwd)
        ...
        commtypes = (
            ...
            CommunicationType(
                ...
                description='Text/voice/video via XMPP (includes Jabber '
                            'and Google Talk)'),
            CommunicationType(
                name='IRC',
                icon='irc',
        ...
        gvars = (NPVariable(name='DAV:SYNC:ROOT',
                            integer_value=1),
                 NPVariable(name='DAV:SYNC:PLUG:VFS',
                            integer_value=1),
                 NPVariable(name='DAV:SYNC:PLUG:USERS',
                            integer_value=1),
                 NPVariable(name='DAV:SYNC:PLUG:GROUPS',
                            integer_value=1),
                 NPVariable(name='DAV:SYNC:PLUG:ABOOKS',
                            integer_value=1),
                 NPVariable(name='DAV:SYNC:PLUG:UABOOKS',
                            integer_value=1))
        for obj in gvars:
            sess.add(obj)
    ...
    def get_menus(self, request):
        ...
        return (Menu('modules', title=loc.translate(_('Modules')), order=10),
                # FIXME: add permission= for users
                Menu('users',
                     title=loc.translate(_('Users')), order=20,
                     direct='users', options={'disableSelection': True}),
                Menu('folders',
                     title=loc.translate(_('Folders')), order=30,
                     direct='folders', permission='BASE_FILES', options={
                       'rootVisible': True,
                       'hideHeaders': True,
                       'columns':     ({
                           'xtype':     'treecolumn',
                       ...
                       'expanded': True}),
                Menu('settings',
                     title=loc.translate(_('Settings')), order=40,
                     direct='settings'),
                Menu('admin',
                     title=loc.translate(_('Administration')), order=50,
                     permission='BASE_ADMIN'))

    def get_js(self, request):
        if request.debug_enabled:
            return (
                'netprofile_core:static/extern/extjs/build/ext-all-debug.js',
                ('netprofile_core:static/extern/extjs/build'
                 '/packages/sencha-charts/build/sencha-charts-debug.js'),
                ('netprofile_core:static/extern/extjs/build'
                 '/packages/ext-theme-classic/build'
                 '/ext-theme-classic-debug.js'),
                ('netprofile_core:static/extern'
                 '/extensible/lib/extensible-all-debug.js'),
        ...
        return (
            ...
            ('netprofile_core:static/extern/extjs/build'
             '/packages/sencha-charts/build/sencha-charts.js'),
            ('netprofile_core:static/extern/extjs/build'
             '/packages/ext-theme-classic/build/ext-theme-classic.js'),
    ...
    def get_local_js(self, request, lang):
        return (('netprofile_core:static/extern/extjs/build'
                 '/packages/ext-locale/build/ext-locale-' + lang + '.js'),
                ('netprofile_core:static/extern'
                 '/extensible/src/locale/extensible-lang-' + lang + '.js'),
                ('netprofile_core:static/webshell'
                 '/locale/webshell-lang-' + lang + '.js'))

    def get_css(self, request):
        if request.debug_enabled:
            return (('netprofile_core:static/extern/extjs/build'
                     '/packages/ext-theme-classic/build/resources'
                     '/ext-theme-classic-all-debug.css'),
                    ('netprofile_core:static/extern/extjs/build'
                     '/packages/sencha-charts/build/classic/resources'
                     '/sencha-charts-all-debug.css'),
                    ('netprofile_core:static/extern/extensible'
            ...
            return (
                SettingSection(
                    ...
                    Setting(
                        ...
                        help_text=_('Allow logging in to the user interface '
                                    'for non-admin users.'),
                        type='bool',
                ...
                SettingSection(
                    ...
                    Setting(
                        ...
                        help_text=_('User ID of the owner '
                                    'of the root folder.'),
                        type='int',
                        default=1,
                        write_cap='ADMIN_VFS',
                    ...
                    Setting(
                        ...
                        help_text=_('Group ID of the owning group '
                                    'of the root folder.'),
                        type='int',
                        default=1,
                        write_cap='ADMIN_VFS',
                    ...
                    Setting(
                        'root_rights',
                        title=_('Root Rights'),
                        help_text=_('Bitmask specifying access rights '
                                    'for the root folder.'),
                        type='int',
                        default=509,
                        write_cap='ADMIN_VFS'),
            ...
            return (
                SettingSection(
                    ...
                    Setting(
                        ...
                        help_text=_('Maximum number of rows to display '
                                    'on a single page of a table or grid.'),
                        type='int',
                        default=30,
                    ...
                    Setting(
                        ...
                        help_text=_('Show current range of displayed entries '
                                    'in grid footer.'),
                        type='bool',
                        default=True),
                    scope='user',
                    title=_('Look and Feel'),
                    help_text=_('Basic settings for customizing '
                                'NetProfile user interface.')),
                SettingSection(
                    'locale',
                    Setting(
                        'csv_charset',
                    ...
                    help_text=_('Options related to language '
