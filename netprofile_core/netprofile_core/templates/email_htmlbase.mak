...
<%def name="mail_block_plain(bgcolor='#ffffff')">
			<tr>
				<td bgcolor="${bgcolor}">
${caller.body()}
				</td>
...
<%def name="mail_block(bgcolor='#ffffff')">
			<tr>
				<td bgcolor="${bgcolor}">
...
<%def name="mail_onecol(color='#555555')">
					<tr>
						<td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: ${color};">
...
<%def name="mail_heading(color='#333333', align='left')">
					<tr>
						<td style="padding: 40px 40px 20px; text-align: ${align};">
							<h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 27px; color: ${color}; font-weight: normal;">${caller.body()}</h1>
						</td>
					</tr>
</%def>
