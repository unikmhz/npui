...
class Module(ModuleBase):
    ...
    def get_sql_data(cls, modobj, vpair, sess):
        ...
        privs = (Privilege(code='NAS_LIST',
                           name=_('NASes: List')),
                 Privilege(code='NAS_CREATE',
                           name=_('NASes: Create')),
                 Privilege(code='NAS_EDIT',
                           name=_('NASes: Edit')),
                 Privilege(code='NAS_DELETE',
                           name=_('NASes: Delete')),
                 Privilege(code='IPPOOLS_LIST',
                           name=_('IP Pools: List')),
                 Privilege(code='IPPOOLS_CREATE',
                           name=_('IP Pools: Create')),
                 Privilege(code='IPPOOLS_EDIT',
                           name=_('IP Pools: Edit')),
                 Privilege(code='IPPOOLS_DELETE',
    ...
    def get_css(self, request):
        return ('netprofile_dialup:static/css/main.css',)
